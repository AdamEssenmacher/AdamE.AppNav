...
/// </summary>
/// <remarks>
/// Provenance is not route identity, route metadata, or route formatting state. AppNav sets it automatically only
...
public sealed record NavigationRequestProvenance
{
    ...
    /// </summary>
    /// <remarks>
    /// AppNav sets this for built-in MAUI app-link ingress. App-owned external sources should set their own
    ...
    /// </summary>
    /// <remarks>
    /// AppNav sets this to the incoming platform app-link URI for built-in MAUI app-link ingress. App-owned
    ...
    /// </summary>
    /// <remarks>
    /// AppNav does not infer this value. App-owned sources should set it only when the provider supplies reliable
    /// referrer context.
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// AppNav does not infer this value. App-owned sources should set notification ids, Branch click ids,
    ...
    /// </summary>
    /// <remarks>
    /// AppNav does not guess this value. App-owned sources should set it only when the app boundary can determine
    ...
    /// </summary>
    /// <remarks>
    /// AppNav leaves this empty for built-in app-link ingress. App-owned sources may use it for stable
