...
public sealed record NavigationAccessDecision
{
        ...
        bool deferOriginalRequest)
    {
        ...
        {
            throw new ArgumentException("Denied navigation decisions must provide a redirect request.", nameof(redirectRequest));
        }
    ...
    {
        return new NavigationAccessDecision(true, redirectRequest: null, deferOriginalRequest: false);
    }
    ...
    public static NavigationAccessDecision Redirect(RouterNavigationRequest redirectRequest)
    {
        ...
        return new NavigationAccessDecision(false, redirectRequest, deferOriginalRequest: false);
    }

    public static NavigationAccessDecision DeferAndRedirect(RouterNavigationRequest redirectRequest)
    {
        ArgumentNullException.ThrowIfNull(redirectRequest);
        return new NavigationAccessDecision(false, redirectRequest, deferOriginalRequest: true);
    }
}
